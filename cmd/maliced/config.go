...
func installCommonConfigFlags(conf *config.Config, flags *pflag.FlagSet) {
	...
	flags.StringVar(&conf.Root, "data-root", defaultDataRoot, "Root directory of persistent Malice state")
...
func installRegistryServiceFlags(options *registry.ServiceOptions, flags *pflag.FlagSet) {
	...
	flags.Var(mirrors, "registry-mirror", "Preferred Malice registry mirror")
